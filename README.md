...
- A library management system made using Postgresql. This project was designed during the course "Relational Databases CMPE232" with [Baturalp Kızıltan](https://github.com/baturalp-kiziltan)
